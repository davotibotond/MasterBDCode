...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 29 19:54:33 2023
...
# Endret funksjon for å beregne gjennomsnittskraften for freeweight
...
# Endret funksjon for å beregne den gjennomsnittlige kurven
def calculate_average_curve(resistance_data, all_positions, freeweight_avg_force):
    ...
    # Normaliserer basert på freeweight gjennomsnittskraft
    avg_force = avg_force / freeweight_avg_force

    return avg_force

# Endret funksjon for å generere og lagre plottene
